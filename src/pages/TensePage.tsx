...
import { BookText, CheckCircle, RotateCcw, Target } from "lucide-react";
...
const TENSE_TYPES = ["Regular Tense", "Conditional Tense", "Inversion"];
...
const DIFFICULTY_LEVELS = [
  {
    value: "easy",
    label: "Easy",
    description: "Basic tense usage with simple sentences",
  },
  {
    value: "medium",
    label: "Medium",
    description: "Intermediate complexity with compound sentences",
  },
  {
    value: "hard",
    label: "Hard",
    description: "Advanced usage with complex grammar structures",
  },
];
      ...
      <div className="space-y-6">
        ...
        <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-md border border-gray-200 dark:border-gray-600">
          <div className="flex items-center">
            <Target
              className={`h-4 w-4 mr-2 ${getDifficultyColor(
                selectedDifficulty
              )}`}
            />
        ...
        {/* Results Section */}
        {showResults && (
          <div className="p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-500 rounded-md">
